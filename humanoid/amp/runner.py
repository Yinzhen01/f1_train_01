...
class AMPOnPolicyRunner(DHOnPolicyRunner):
    def __init__(self, env, train_cfg, experiment, log_dir, device):
        ...
        signal = experiment.cfg.get("signal", experiment.cfg.get("horizon", experiment.cfg.get('contact_refinement', experiment.cfg.get('progress', experiment.cfg.get('direction', {})))))
