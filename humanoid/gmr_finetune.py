...
SOURCE_SHA256 = "5e89389e9eb3392759a78ff6295c2a395d3af0c8855c49499bf57fa8e7a8c5f9"
SOURCE_REFERENCE_SHA256 = "d625efc73972b4f4952587ac6391543b6d747b404184703361a394e0b6bca4fb"
SOURCE_COMPLETED_UPDATES = 5000
...
def locate_verified_checkpoint(explicit_path, roots):
    ...
    for root in roots:
        root = Path(root)
        if root.is_dir():
            candidates.update(root.rglob("model_5000*.pt"))
    for candidate in sorted(candidates):
        if sha256(candidate) == SOURCE_SHA256:
            return candidate
    raise FileNotFoundError("The approved model_5000 checkpoint was not mounted; no scratch fallback")
